...
\textbf{Quelles sont les différentes approches pour donner de la voix au peuple, leurs évolutions et quelles sont les conséquences de leurs implémentations?}
...
\section*{Introduction}
 ...
 Aristote, philosophe grec, déjà conçoit que celle-ci doit s'accompagner d'une séparation des pouvoirs. 
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{./images/Assemblée_Eucclesia.png}
...
\section{La II\up{nd} République Française (1848) et sa portée}
...
\subsection{Avantages / Désavantages de son mode de fonctionnement} % TODO rename & revamp
